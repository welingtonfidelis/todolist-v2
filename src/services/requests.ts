...
export const listTodo = async (
  filter: ListTodoProps
): Promise<ResponseInterface<ListTodoResponse[]>> => {
...
export const findTodoById = async (
  id: number
): Promise<ResponseInterface<TodoInterface>> => {
...
export const deleTodo = async (id: number): Promise<ResponseInterface<{}>> => {
